...
<div class="max-w-screen-xl mx-auto px-20 pt-20 pb-44 flex flex-col items-center">
    ...
    {{-- Step 3a --}}
    <div class="mt-[7.75rem] flex flex-col items-center gap-12">
        <img
    ...
    {{-- Step 3b --}}
    <div class="mt-[10.5rem] flex flex-col items-center gap-12">
        <img
    ...
    {{-- Step 3c --}}
    <div class="mt-[9.5rem] flex flex-col items-center gap-12">
        <img
