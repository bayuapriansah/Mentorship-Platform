...
<div class="relative max-w-screen-xl mx-auto">
    ...
    {{-- Dots & shadow - top-left step 2 --}}
    <div
        class="absolute top-[1010px] -left-28 w-[339px] h-[186px]"
        style="background: url({{ asset('/assets/img/icon/profile/dots.png') }}), transparent -0.123px -12.977px / 100.073% 106.977% no-repeat"
    ></div>
    <div
        class="absolute top-[820px] -left-[40%] translate-x-[40%] w-[621px] h-[621px] bg-[#E4E7FF] rounded-full opacity-60 blur-[100px]"
    ></div>

    {{-- Dots - top-left step 6 --}}
    <div
        class="absolute top-[2737px] left-0 w-[339px] h-[186px]"
        style="background: url({{ asset('/assets/img/icon/profile/dots.png') }}), transparent -0.123px -12.977px / 100.073% 106.977% no-repeat"
    ></div>

    {{-- Dots & shadow - bottom-right step 6 --}}
    <div
        class="absolute top-[3240px] -right-6 w-[339px] h-[186px]"
        style="background: url({{ asset('/assets/img/icon/profile/dots.png') }}), transparent -0.123px -12.977px / 100.073% 106.977% no-repeat"
    ></div>
    <div
        class="absolute top-[2930px] -right-[40%] -translate-x-[40%] w-[755px] h-[755px] bg-[#E4E7FF] rounded-full opacity-60 blur-[100px]"
    ></div>
    ...
    <div class="relative z-[2] max-w-screen-xl mx-auto px-20 pt-20 pb-44 flex flex-col items-center">
        ...
        <div class="relative mt-20 flex gap-[5.3rem]">
            <img
                src="{{ asset('/assets/img/skills-track-info/line-1-to-2.png') }}"
                class="absolute -top-24 left-[22rem] scale-y-75 scale-x-110"
            >
        ...
        <div class="relative mt-[4.25rem] flex gap-[7.5rem]">
            ...
            <img
                src="{{ asset('/assets/img/skills-track-info/line-2-to-3.png') }}"
                class="absolute -top-28 right-96"
            >
        </div>

        {{-- Step 4 --}}
        <div class="relative mt-[10.5rem] flex gap-24">
            <img
                src="{{ asset('/assets/img/skills-track-info/line-3-to-4.png') }}"
                class="absolute -top-44 left-80 scale-x-125"
            >
        ...
        <div class="relative mt-[10.65rem] flex gap-[7.7rem]">
            ...
            <img
                src="{{ asset('/assets/img/skills-track-info/line-4-to-5.png') }}"
                class="absolute -top-[11.4rem] left-[27rem] scale-x-125 scale-y-[0.8]"
            >

            <img
                src="{{ asset('/assets/img/skills-track-info/line-5-backto-3.png') }}"
                class="absolute bottom-72 left-[23.5rem] scale-x-110"
            >
        </div>
        ...
        <div class="relative mt-60 flex gap-20">
            <img
                src="{{ asset('/assets/img/skills-track-info/line-5-to-6.png') }}"
                class="absolute bottom-56 left-80 scale-x-125"
            >

            <img
                src="{{ asset('/assets/img/skills-track-info/step-6.png') }}"
                alt="Step 6"
                class="relative z-[3] w-[516px]"
            >
