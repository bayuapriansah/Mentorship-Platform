            ...
            @if (isLoggedIn())
                ...
                <div id="dropdownRightEnd"
                    ...
                    <div class="py-2 text-sm text-gray-700 dark:text-gray-200">
                        <a href="{{ route('internal-document-menu') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Support</a>
