    ...
    <div class="max-w-[1366px] mx-auto px-16 pt-24 pb-16 mb-0 grid grid-cols-12 gap-11 grid-flow-col container">
      ...
      <div class="col-start-6 col-span-2 flex flex-col">
        <ul class="text-dark-blue text-xs font-normal">
          <li class="pb-3"><a href="/for-industry-partners">For Industry Partners</a></li>
        ...
        <ul class="text-dark-blue text-xs font-normal">
          ...
          <li class="pb-3">
            @if (Auth::guard('student')->check())
              ...
              <div id="popup-contact-student" tabindex="-1" class="fixed z-80 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
