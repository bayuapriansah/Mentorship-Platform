<aside class="w-full bg-white absolute -top-5 rounded-xl border border-light-blue p-5">
  ...
  <div class="flex flex-col">
    ...
    <a href="{{asset('storage/'.$student->certificate)}}" target="_blank" class="text-sm text-center font-normal text-white bg-darker-blue hover:bg-dark-blue rounded-full p-2">Download Certificate</a>
