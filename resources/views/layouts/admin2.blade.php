            ...
            setup: function(editor) {
                editor.on('GetContent', function(e) {
                    ...
                    var newContent = content.replace(
                        /data-mce-src="\.\.\/\.\.\/\.\.\/storage\/uploads\//g, 'data-mce-src="' +
                        websiteUrl + '/storage/uploads/');
...
<body>
    <div class="max-w-[2000px] mx-auto">
        <div class="flex">
            <div
                class="w-1/5 min-h-screen bg-gradient-to-b from-darker-blue to-dark-blue items-center py-9 px-10 justify-center">
                <div class="flex-col">
                    <a href="{{ route('index') }}">
                        <img src="{{ asset('/assets/img/logo/impact-festival-white-logo.png') }}"
                            class="w-full object-scale-down mx-auto" alt="Logo">
                    </a>
                </div>
                    ...
                    <div class="space-x-9">
                        ...
                        @if (Auth::guard('web')->check())
                            ...
                            @elseif (Auth::guard('mentor')->check())
                                <a href="/dashboard/profile/{{ Auth::guard('mentor')->user()->id }}/edit"
                                    type="button"
                                    class="relative inline-flex items-center text-sm font-medium text-center text-light-blue rounded-lg hover:text-dark-blue focus:ring-4 focus:outline-none focus:ring-blue-300">
                                @elseif (Auth::guard('customer')->check())
                                    <a href="/dashboard/profile/{{ Auth::guard('customer')->user()->id }}/edit"
                                        type="button"
                                        class="relative inline-flex items-center text-sm font-medium text-center text-light-blue rounded-lg hover:text-dark-blue focus:ring-4 focus:outline-none focus:ring-blue-300">
                        @endif
                                ...
                                <div
                                    ...
                                    <div class="relative bg-white rounded-xl shadow-2xl">
                                        ...
                                        <div class="p-6 text-left space-x-4">
                                            ...
                                            <h3 class="text-dark-blue text-2xl font-medium mb-3 text-left">Are you sure
                                                you want to Logout?</h3>
    ...
    <script type="text/javascript" charset="utf8" src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js">
    </script>
