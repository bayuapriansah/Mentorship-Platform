...
<body class="bg-profile-grey">
    ...
    <aside id="logo-sidebar" aria-label="Sidebar" aria-hidden="true" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-dark-blue border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-dark-blue dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="{{ route('dashboard.admin') }}" class="flex items-center p-2 {{ request()->routeIs('dashboard.admin') ? 'text-gray-900 bg-gray-100 dark:bg-gray-700' : 'text-gray-200 hover:text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700' }} rounded-lg group">
