...
<body class="bg-profile-grey">

    <nav class="fixed top-0 z-50 w-full bg-dark-blue border-b border-dark-blue dark:bg-gray-800 dark:border-gray-700">
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar"
                        aria-controls="logo-sidebar" type="button"
                        class="inline-flex items-center p-2 text-sm text-gray-200 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                    ...
                    <a href="{{ route('dashboard.admin') }}" class="flex ml-2 md:mr-24">
                        <img src="{{ asset('assets/image/IntelDigitalReadinessWhiteLogo.svg') }}" class="h-10 mr-3"
    ...
    <aside id="logo-sidebar" aria-label="Sidebar" aria-hidden="true"
        class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-dark-blue border-r border-dark-blue sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-dark-blue dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="{{ route('dashboard.admin') }}"
                        class="flex items-center p-2 {{ request()->routeIs('dashboard.admin') ? 'text-gray-900 bg-gray-100 dark:bg-gray-700' : 'text-gray-200 hover:text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700' }} rounded-lg group">
    ...
    <script>
        ...
        const openToggle = (id) => {
            const dropdownHover = document.getElementById(`dropdownHover${id}`);
            if (dropdownHover.classList.contains('hidden')) {
                dropdownHover.classList.remove('hidden');
            } else {
