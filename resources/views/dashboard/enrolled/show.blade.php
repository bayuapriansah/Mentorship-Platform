...
<table id="dataTable" class="bg-white rounded-xl border border-light-blue mt-16 allStudent">
  ...
  <tbody>
    ...
    <tr>
            ...
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to change the?</h3>
      ...
      <!-- Modal toggle -->
      <button data-modal-target="defaultModal" data-modal-toggle="defaultModal" class="block py-1 px-3 bg-dark-blue hover:bg-darker-blue rounded-md text-white" type="button">
        View detail
      </button>
