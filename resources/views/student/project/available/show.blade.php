...
<div class="max-w-[1366px] mx-auto pl-16 pt-4 pb-20 grid grid-cols-12 gap-8 grid-flow-col items-center bg-white">
    <div class="col-span-8 min-h-[600px]">
            ...
            <div class="col-span-6">
                ...
                @if(Auth::guard('student')->check())
                    <div class="mt-6 flex items-center gap-4">
                        <div class="border border-light-blue rounded-[10px] bg-white p-2 flex items-center space-x-2">
        ...
        <div class="mt-10 grid grid-cols-12 gap-4 grid-flow-col">
        ...
        {{-- Project Details --}}
        <div class="grid grid-cols-12 gap-4 grid-flow-col">
            <div class="problem col-span-12 pr-8 text-black text-justify font-normal">
                {!!$project->problem!!}
            </div>
        </div>
