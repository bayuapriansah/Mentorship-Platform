    ...
    <div class="grid grid-cols-12 gap-4 grid-flow-col mt-14">
      ...
      <div class="col-start-10 col-span-2">
        @if(Auth::guard('student')->check())
          ...
          <div id="popup-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                <div class="relative w-full h-full max-w-4xl md:h-auto shadow-xl shadow-blue-500/50">
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="p-6 text-left">
                            ...
                            <button data-modal-hide="popup-modal" type="button" class="intelOne text-dark-blue text-sm font-normal hover:text-darker-blue px-12 py-3 rounded-full shadow-xl">Cancel</button>
                        </div>
                    </div>
                </div>
            </div>
