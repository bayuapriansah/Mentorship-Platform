        ...
        <div class="border border-light-blue p-3 rounded-xl">
          ...
          <div class="form">
            ...
            <div class="px-4 py-2 bg-white rounded-t-lg ">
                ...
                <textarea id="comment" rows="4" class="w-full px-0 text-sm text-gray-900 bg-white border-0  focus:outline-none dark:text-white dark:placeholder-gray-400" placeholder="Write a comment..." name="message" required></textarea>
            </div>
