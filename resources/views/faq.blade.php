      ...
      <div id="accordion-collapse" data-accordion="collapse" class="">
        ...
        <div id="accordion-collapse-body-1" class="hidden pb-2" aria-labelledby="accordion-collapse-heading-1">
          <div class="p-5 font-light border rounded-xl border-gray-200 ">
            ...
            <p class="text-gray-500 ">Check out this guide to learn how to <a href="/docs/getting-started/introduction/" class="text-blue-600 ">get started</a> and start developing websites even faster with components on top of Tailwind CSS.</p>
          </div>
        </div>
