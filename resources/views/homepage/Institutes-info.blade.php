...
@section('content')
{{-- Body Contents --}}
<div style="background-image: url({{ asset('assets/img/for_institutes/institutes.jpg') }}); background-size: cover;" class="max-w-full bg-no-repeat phone:bg-right-min-28 hd:bg-top-min-20 laptop:bg-top-min-20 fhd:bg-top-min-32 py-24">
        ...
        <div class="grid md:grid-cols-2 gap-4 items-center ">
            <div class="my-auto bg-darker-blue/[0.9] rounded-2xl px-8 py-4 mt-48 hd:mt-0 hd:px-16 hd:py-8">
                <h2 class="intelOne text-white font-bold text-xl hd:text-3xl leading-11">
                    <span>Information for</span> <span class="text-light-brown"> Institutes</span>
                </h2>
                <span class="intelOne text-white font-light text-sm hd:text-lg leading-6">Enroll your institute today to provide a virtual environment for students to work on real-world projects that simulate the demands of the workforce.</span>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="max-w-screen-xl mx-auto px-6 py-4 pt-20" id="AiForFuture">
        <div class="grid md:grid-cols-2 gap-4 items-center">
            <div class="my-auto">
                <h2 class="intelOne text-dark-blue font-bold text-4xl">Information<br><span class="text-light-brown"> For Institutes</span></h2>
            </div>
            <div class="relative my-auto">
                <p class="mb-4 text-black text-justify">As he job market becomes increasingly competitive, students need to be well-prepared to stand out among the competition. Employers now require more than just academic credentials; they want candidtaes who have practical experience and relevant skills. On our platform students will have the opportunity to work on AI projects and acquire practical experience to help them stand out in the job market. What can your institution and your students gain from joining our platform.</p>
            </div>
        </div>
    </div>
    ...
    <div class="flex items-center justify-center pt-20">
        <div class="max-w-screen-xl text-center">
            <p class="text-dark-blue font-bold py-3 text-4xl">Associated Institutes</p>
        </div>
    </div>
