  ...
  <div class="max-w-[1366px] mx-auto px-16 pt-16 grid grid-cols-12 gap-11 grid-flow-col bg-lightest-blue">
    <div class="col-span-6">
      ...
      <form action="{{ route('otp.generate') }}" method="post" id="register">
        ...
        <input class="text w-full border-2 rounded mt-4 h-11 py-2 px-4 text-lightest-grey::placeholder leading-tight " name="email" placeholder="Enter OTP*" id="otp" name="otp" required>
