    ...
    public function up()
    {
        ...
        DB::unprepared('
            ...
            BEGIN
                ...
                DECLARE isConfirm CURSOR FOR SELECT is_complete FROM submissions WHERE project_id=NEW.project_id AND section_id=(SELECT MAX(section_id) FROM submissions WHERE project_id=NEW.project_id);
                ...
                FETCH isConfirm INTO condition_confirm;
                IF done THEN
                    LEAVE loop_sections;
                END IF;
                IF condition_confirm = 0 THEN
                ...
                ELSEIF condition_confirm = 1 THEN
                    INSERT INTO submissions (section_id, student_id, project_id, is_complete, release_date, taskNumber, created_at, updated_at)
                    VALUES (section_ids, student_ids, NEW.project_id, 0, CURDATE(), taskNombre, NOW(), NOW());
                END IF;
                END LOOP;
