        ...
        DB::unprepared('
            ...
            BEGIN
                ...
                IF done THEN
                    LEAVE loop_sections;
                END IF;
                INSERT INTO submissions (section_id, student_id, project_id, is_complete, release_date, dueDate, taskNumber, created_at, updated_at)
                VALUES (section_id, NEW.student_id, NEW.project_id, 0, releases_date, DATE_ADD(releases_date,INTERVAL loop_day DAY), taskNombre, NOW(), NOW());
