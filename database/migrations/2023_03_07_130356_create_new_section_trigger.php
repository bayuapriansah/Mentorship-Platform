    ...
    public function up()
    {
        ...
        DB::unprepared('
            ...
            BEGIN
                ...
                SELECT max(taskNumber) INTO taskNombre FROM submissions WHERE project_id = NEW.project_id;
                ...
                VALUES (section_ids, student_ids, NEW.project_id, 0, DATE_ADD(releases_date,INTERVAL duration_day DAY), taskNombre + 1, NOW(), NOW());
                END LOOP;
